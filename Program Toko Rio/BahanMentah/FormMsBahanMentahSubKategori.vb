...
Public Class FormMsBahanMentahSubKategori
    ...
    Private Sub viewAllData(ByVal cr As String, ByVal opt As String)
        sql = "select KdBahanMentahSubKategori Kode,BahanMentahSubKategori 'Sub Kategori' from  " & tab
        If opt <> "" Then
            Dim col As String = ""
            If opt = "Sub Kategori" Then
                col = "BahanMentahSubKategori"
            End If
            sql &= "  where " & col & "  like '%" & cr & "%'  and KdBahanMentahSubKategori <>'BS00000000'"
        Else
            sql &= "  where KdBahanMentahSubKategori <>'BS00000000'"
        End If
    ...
    Private Sub FormMsBahanMentahTipe_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        tab = " MsBahanMentahSubKategori "
        PK = "  KdBahanMentahSubKategori  "
        ubahAktif(False)
        viewAllData("", "")
        posisi = 0
        setData()
    ...
    Private Sub generateCode()
        ...
        Dim reader = getCode("MsBahanMentahSubKategori", "KdBahanMentahSubKategori")
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If (DataGridView1.RowCount) Then
            ...
            If MsgBox("Anda yakin ingin menghapus kode sub kategori " & selected_cell & "?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Confirmation") = MsgBoxResult.Yes Then
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If txtNama.Text = "" Then
            msgInfo("Sub kategori harus diisi")
            txtNama.Focus()
        Else
            If status = "add" Then
            ...
            ElseIf status = "update" Then
                Try
                    sql = "update   " & tab & "  set  BahanMentahSubKategori='" & Trim(txtNama.Text) & "' where  " & PK & "='" + txtID.Text + "' "
                    execute_update(sql)
                    viewAllData("", "")
                    ubahAktif(False)
